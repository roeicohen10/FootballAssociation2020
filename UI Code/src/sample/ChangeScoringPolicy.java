...
public class ChangeScoringPolicy {
    @FXML
    private TextField WinText;
    @FXML
    private TextField LossText;
    @FXML
    private TextField TieText;
    ...
    public void ChangePolicyAttempt(ActionEvent actionEvent) throws IOException {
        ...
        Response response = con.ChangeScoringPolicy(Policies.getChosenname(),WinText.getText(),LossText.getText(),TieText.getText());
